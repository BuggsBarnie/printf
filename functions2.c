...
/**
 * print_pointer - Function that prints the value stored in a pointer
 * @types: Arguments listed
 * @buffer: Array for printed
...
/**
 * print_non_printable - Displays ascii codes in hex format of chars
 * @types: Arguments listed
...
/**
 * print_reverse - Function that displays a string in reverse
 * @types: Arguments listed
 * @buffer: Array for printing
 * @flags:  Counts the flags which are active
 * @width: Specified dimension
